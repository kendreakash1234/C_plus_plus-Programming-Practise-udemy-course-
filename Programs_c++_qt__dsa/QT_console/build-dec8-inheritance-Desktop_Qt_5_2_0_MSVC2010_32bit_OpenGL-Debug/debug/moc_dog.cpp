...
#include "../../dec8-inheritance/dog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Dog_t, stringdata) + ofs \
...
const QMetaObject Dog::staticMetaObject = {
    { &Animal::staticMetaObject, qt_meta_stringdata_Dog.data,
      qt_meta_data_Dog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Dog.stringdata))
        return static_cast<void*>(const_cast< Dog*>(this));
