...
#include "../../dec9-static-variable-function/animal.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Animal_t, stringdata) + ofs \
...
const QMetaObject Animal::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Animal.data,
      qt_meta_data_Animal,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Animal.stringdata))
