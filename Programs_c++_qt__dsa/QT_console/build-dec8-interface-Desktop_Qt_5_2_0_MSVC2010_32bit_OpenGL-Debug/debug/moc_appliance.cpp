...
#include "../../dec8-interface/appliance.h"
...
const QMetaObject Appliance::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Appliance.data,
...
void *Appliance::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "freezer"))
        return static_cast< freezer*>(const_cast< Appliance*>(this));
    if (!strcmp(_clname, "microwave"))
        return static_cast< microwave*>(const_cast< Appliance*>(this));
    if (!strcmp(_clname, "toaster"))
        return static_cast< toaster*>(const_cast< Appliance*>(this));
