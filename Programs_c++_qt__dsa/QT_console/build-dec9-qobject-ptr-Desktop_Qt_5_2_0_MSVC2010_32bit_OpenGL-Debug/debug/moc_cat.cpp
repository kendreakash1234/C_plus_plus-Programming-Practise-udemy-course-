...
#include "../../dec9-qobject-ptr/cat.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Cat_t, stringdata) + ofs \
...
const QMetaObject Cat::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Cat.data,
      qt_meta_data_Cat,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Cat.stringdata))
