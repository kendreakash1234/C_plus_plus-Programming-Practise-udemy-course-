...
#include "../../dec9-signal-slot-connection/source.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Source_t, stringdata) + ofs \
...
void Source::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Source::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Source::mySignal)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Source::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Source.data,
      qt_meta_data_Source,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Source.stringdata))
