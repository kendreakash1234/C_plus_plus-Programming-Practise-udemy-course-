...
#include "../../QUDPSocketChatExample/commandline.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CommandLine_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 21, 5)
    ...
    "CommandLine\0command\0\0value\0"
};
...
void CommandLine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CommandLine::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CommandLine::command)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CommandLine::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CommandLine.data,
      qt_meta_data_CommandLine,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CommandLine.stringdata))
